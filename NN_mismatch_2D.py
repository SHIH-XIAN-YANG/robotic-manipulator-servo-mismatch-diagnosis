...
input_data = np.stack((tracking_err_x, tracking_err_y, tracking_err_z, tracking_err_Psi, tracking_err_Phi, tracking_err_theta,tracking_err), axis=1)

input_shape = input_data.shape[1] #length of row in array contouring_err
