...
from model_playground import TransformerClassifier
...
model = TransformerClassifier(input_size=input_shape, num_classes=6)
...
plt.savefig(f'transformer_{month}_{day}_{hour}_{minute}_Confusion_Matrix.png')
...
plt.savefig(f'transformer_{month}_{day}_{hour}_{minute}_ROC_curve.png')

# Save the model (optional)
torch.save(best_model, f"transformer_{month}_{day}_{hour}_{minute}_best_model_acc_{best_acc}.pth")
plt.figure()
...
plt.savefig(f'transformer_{month}_{day}_{hour}_{minute}_loss.png')
...
plt.grid(True)
plt.savefig(f'transformer_{month}_{day}_{hour}_{minute}_top1_accuracy.png')
...
plt.grid(True)
plt.savefig(f'transformer_{month}_{day}_{hour}_{minute}_top2_accuracy.png')
# Save the model
# %%
